...
<div id="dialog-confirm" title="Επιβεβαίωση Διαγραφής?">
    ...
    <p id="insidedialog">
        <span class="ui-icon ui-icon-alert" style="float:left; margin:12px 12px 20px 0;"></span> Πρόκειτε να διαγράψετε
        τον πίνακα με τα στοιχεία των εκπαιδευτικών. Είστε σίγουρος/ή?
            ...
            <div class="modal-body">
                ...
                <div class="contentcsv">
                    ...
                    <br><b>Παρατήρηση: Δεν δημιουργείται ο πίνακας της MySQL με το όνομα <em>smsmessages</em> που
                        θα φιλοξενεί τα στοιχεία των sms που αποστέλλονται μέσω της εφαρμογής. Ο πίνακας αυτός
                        δημιουργείται
                        με την εισαγωγή των μαθητών μέσω XML ή από την επιλογή του μενού SMS Admin Board -> Διαχείριση
                        πίνακα SMS</b>
                ...
                <div class="contentcsvutf8">
                    ...
                    δεδομένων.<strong> Επειδή υπάρχει η περίπτωση ο αυτόματος εντοπισμός κωδικοποίησης
                        ...
                        υπάρχει η περίπτωση να χρειάζεται η μετατροπή σε utf-8 μέσω τρίτου εργαλείου (π.χ.
                        notepad++)</strong>
                    <br><b>Παρατήρηση: Όμοια και εδώ δεν δημιουργείται ο πίνακας της mysql με το όνομα
                        <em>smsmessages</em>.
                        <br>Παρατηρήσεις: 1) Εάν οι πίνακες ήδη υπάρχουν δεν θα αλλοιωθούν 2) Η παράμετρος ΑΦΜ αποτελεί
                        μοναδικό χαρακτηριστικό και είναι απαραίτητη η ύπαρξή του.
                </div>
            ...
            <div class="panel-body">
                ...
                <p style="margin-top: 10px ; margin-left: 20px">
                    ...
                    <button class="btn-primary btn-lg" id="buttonform" type='submit'
                            onclick='this.form.action="import_to_mysql_csv.php?method=1";'>
                        Εισαγωγή αρχείου CSV
                    </button>
                    <button class="btn-primary btn-lg" id="buttonformutf8" type='submit'
                            onclick='this.form.action="import_to_mysql_csv.php?method=2"'>
